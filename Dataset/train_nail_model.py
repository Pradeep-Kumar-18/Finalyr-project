...
callbacks = [
    ...
    ModelCheckpoint(filepath=os.path.join(model_dir, "nail_model_refining.h5"), monitor="val_accuracy", save_best_only=True, verbose=1)
]
...
callbacks_fine = [
    ...
    ModelCheckpoint(filepath=os.path.join(model_dir, "nail_model_final.h5"), monitor="val_accuracy", save_best_only=True, verbose=1)
]
...
model.save(os.path.join(model_dir, "nail_model_final.h5"))
print("Improved Nail model saved successfully.")